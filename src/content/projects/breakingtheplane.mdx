...
description: Visualizing two-dimensional functions in AR from handwritten input. Accepted to CHI '24.
date: 2024-01-16
heroImage: ../../assets/breakingtheplane.png
thumbnailImage: ../../assets/breakingtheplane.png
tags:
  - code
  - research
links:
