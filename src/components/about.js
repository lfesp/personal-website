      ...
      <div className="light">
        <div className="container" id="about">
            <Section className="about"> 
              ...
              <div className="row"> 
                  <div className="main-text thin">
                      <p>At Princeton, I've been spending my time building webapps with <a href="https://www.hoagie.io/" className="light">Hoagie.io</a>, performing in the <a href="https://www.princetonrocks.com/" className="light">Princeton University Rock Ensemble</a>, and developing my leadership skills as part of a <a href="https://scholarsoffinance.org/" className="light">nationwide organization</a> for ethics in industry</p>
                  </div>
              </div>
            </Section>
        </div>
