...
const About = () => {
  return (
    <Section className="about" dark={false} id="about"> 
      ...
      <div className="row"> 
        <div className="main-text thin">
          <p>Now, at Princeton University, I'm pursuing my interests in and out of the classroom by assisting course staff as a grader for COS 226 (Algorithms and Data Structures), directing the development of an integrated application platform for students with <a href="https://www.hoagie.io/" className="light" target="_blank" rel="noreferrer">hoagie.io</a>, helping direct the <a href="https://dn.businesstoday.org/" className="light" target="_blank" rel="noreferrer">nation's first and only all-expenses-paid design conference for undergraduate creatives</a>, performing in the <a href="https://www.princetonrocks.com/" className="light" target="_blank" rel="noreferrer">Princeton University Rock Ensemble</a>, and developing my leadership skills as a member of a <a href="https://scholarsoffinance.org/" className="light" target="_blank" rel="noreferrer">nationwide organization advocating for professional ethics</a>.</p>
          <p>Since this past summer, I’ve been working as lead developer of a <a href="https://kellercenter.princeton.edu/people/startups-teams/berry" className="light" target="_blank" rel="noreferrer">Keller Center-sponsored startup venture</a> to build a browser extension that will facilitate online grocery shopping for those with diabetes and other nutrition-reliant medical conditions.</p>
