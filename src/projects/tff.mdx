...
dark: true
date: 2022-05-03
thumbnail: tff_thumbnail.png
thumbnail_alt_text: Trenton Health Team logo
image: tff.png
image_alt_text: preview of "trenton food interview" web application ui
---
### *description
...
implemented according to **AJAX** (really, AJAJ) principles, we designed our backend API to conform to the **REST** architecture specifications and facilitate this client-side rendering.
...
***
[visit application](https://trentonfoodfinder.herokuapp.com/)
